    ...
    <main className="bg-crowd bg-cover bg-center bg-no-repeat w-full">   
      ...
      <div className="py-10"></div>
       ...
       <div className="flex flex-col">
        <label htmlFor="email" className="text-start mt-4 text-sm font-semibold ">Email Address: </label>
        ...
        <label htmlFor="password"  className="text-start text-sm mt-2 mb-0 font-semibold">Password: </label>
