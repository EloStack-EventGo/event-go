  ...
  return (
    <div className="transparent h-32 w-lvw flex flex-row z-10 justify-between pr-9">
      <div className="flex flex-row gap-10 items-center">
        ...
        <p className="font-black text-xl pt-1"> Explore </p>
        <p className="font-black text-xl pt-1"> Sports </p>
        <p className="font-black text-xl pt-1">Theatre & Comedy</p>
        <p className="font-black text-xl pt-1"> Music </p>
      </div>
